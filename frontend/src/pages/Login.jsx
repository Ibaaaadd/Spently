      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white dark:bg-dark-card rounded-2xl shadow-lg dark:shadow-card border border-gray-200 dark:border-dark-border p-6 sm:p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
            ...
            <div className="bg-primary/10 border border-primary/30 rounded-lg p-2.5 sm:p-3 mb-3 sm:mb-4">
              <p className="text-xs font-semibold mb-1 text-primary dark:text-primary">🎉 Demo Credentials:</p>
              <p className="text-xs text-gray-700 dark:text-gray-300">Email: <span className="font-mono text-gray-900 dark:text-white">demo@spently.com</span></p>
              <p className="text-xs text-gray-700 dark:text-gray-300">Password: <span className="font-mono text-gray-900 dark:text-white">password</span></p>
            </div>
