...
import { LayoutDashboard, Receipt, FolderOpen, TrendingUp, Moon, Sun, LogOut } from 'lucide-react';
  ...
  return (
    <>
      ...
      <div className="hidden lg:flex w-64 h-screen bg-white dark:bg-dark-card border-r border-gray-200 dark:border-dark-border fixed left-0 top-0 flex-col transition-colors duration-200">
        ...
        {/* Footer */}
        <div className="mt-auto p-4 space-y-2 border-t border-gray-200 dark:border-dark-border">
          <button
      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-white dark:bg-dark-card border-t border-gray-200 dark:border-dark-border z-50 transition-colors duration-200">
        <nav className="flex justify-around items-center py-2">
          ...
          <button
            onClick={toggleTheme}
            className="flex flex-col items-center justify-center py-2 px-3 rounded-lg transition-all duration-200 flex-1 text-gray-500 dark:text-gray-400"
          >
          ...
          <NavLink
            to="/expenses"
            className={({ isActive }) =>
              `flex flex-col items-center justify-center py-2 px-3 rounded-lg transition-all duration-200 flex-1 ${
                isActive
                  ? 'text-primary'
          ...
          <button
            onClick={handleLogout}
            className="flex flex-col items-center justify-center py-2 px-3 rounded-lg transition-all duration-200 flex-1 text-red-600 dark:text-red-400"
          >
